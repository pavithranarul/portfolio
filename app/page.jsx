...
const Home = () => {
  const handleDownload = () => {
    ...
    link.href = "/assets/resume/Resume.pages"; // Path to your file
    link.download = "Resume.pages"; // Optional: specify the downloaded file name
    link.click();
  };
        ...
        <div className="text-center xl:text-left order-2 xl:order-none">
          ...
          <div className="flex flex-col xl:flex-row items-center gap-8 ">
            ...
            <div className="mb-8 xl:mb-0">
              <Social containerStyles="flex gap-7" 
